...
export default class DetailController {
    ...
    async getShipInfo(imo){
        ...
        var shipId = await this.imoConvertToShipId(imo);

        var temp = await shipId.data[0].SHIP_ID;

        console.log(temp);

        var url = "https://www.marinetraffic.com/en/ais/get_info_window_json?asset_type=ship&id="+temp;
    ...
    async imoConvertToShipId(imo){

        var url = "https://www.marinetraffic.com/en/reports?asset_type=vessels&columns=flag,shipname,photo,recognized_next_port,reported_eta,reported_destination,current_port,imo,ship_type,show_on_live_map,time_of_latest_position,lat_of_latest_position,lon_of_latest_position&imo="+imo;
